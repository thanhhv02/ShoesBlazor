...
export function nextSlide() { slide_index = slide_index + 1 === slides.length ? 0 : slide_index + 1 }

export function prevSlide() { slide_index = slide_index - 1 < 0 ? slides.length - 1 : slide_index - 1 }
